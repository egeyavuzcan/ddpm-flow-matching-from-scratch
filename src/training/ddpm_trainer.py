...
Handles the training loop for DDPM models.
"""
import torch
...
class DDPMTrainer:
    ...
    def __init__(
        ...
        self.forward_process = DDPMForwardProcess(self.schedule)
    ...
    def train_step(
        ...
        # Sample timesteps
        t = self.forward_process.sample_timesteps(batch_size, self.device)
        
        # Add noise
        x_t, noise = self.forward_process.add_noise(x_0, t)
        
        # Predict noise
        noise_pred = self.model(x_t, t, class_label)
